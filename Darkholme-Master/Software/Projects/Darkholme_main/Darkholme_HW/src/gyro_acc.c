...
/*14/08/2015: replaced IMU with MPU6050 */
...
//Data conversion made redundent by the tm_mpu library
...
void CovertData(void)
{
    ...
    Gyro_X_raw = MPU6050_Data0.Gyroscope_X;
    Gyro_Y_raw =  MPU6050_Data0.Gyroscope_Y;
    Gyro_Z_raw =  MPU6050_Data0.Gyroscope_Z;
    
    ACC_X_raw =  MPU6050_Data0.Accelerometer_X;
    ACC_Y_raw = MPU6050_Data0.Accelerometer_Y;
    ACC_Z_raw = MPU6050_Data0.Accelerometer_Z;
...
{
    /*
    This is made reduendent by tm_mpu library, this function is left unused
    */
    //	// write 0x202F
    //	while (SPI_I2S_GetFlagStatus(SPI2, SPI_I2S_FLAG_TXE) == RESET);
...
void __IMU_READ_ISR(void){
    ...
    if (sensor1) {
        /* Read all data from MPU6050 sensor 1 */
